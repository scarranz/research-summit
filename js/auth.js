...
const ROLE_CONFIG = {
  ...
  admin: { name: 'Admin', label: 'Admin', allowedPages: ['research', 'portfolio', 'market-analysis', 'hedge-funds', 'team', 'fund-returns', 'tools', 'dcf-models', 'betas', 'derivatives'], defaultPage: 'research' },
};
