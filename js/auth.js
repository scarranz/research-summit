...
const ROLE_CONFIG = {
  ...
  admin: { name: 'Admin', label: 'Admin', allowedPages: ['research', 'portfolio', 'market-analysis', 'hedge-funds', 'team', 'fund-returns', 'covered-calls', 'tools', 'dcf-models', 'betas', 'buy-calls'], defaultPage: 'research' },
};
