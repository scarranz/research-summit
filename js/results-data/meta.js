    ...
    q: {
      ...
      metrics: {
        rev: { label: 'Total Revenue', short: 'Total revenue', group: 'Revenue', unit: 'usdM',
          ...
          act:    [28645, 31999, 34146, 40111, 36455, 39071, 40589, 48385, 42314, 47516, 51242, 59893, 56311, 60801, null, null],
          ...
          guideLo:[26000, 29500, 32000, 36500, 34500, 36500, 38500, 45000, 39500, 42500, 47500, 56000, 53500, 58000, 61000, null],
          guideHi:[28500, 32000, 34500, 40000, 37000, 39000, 41000, 48000, 41800, 45500, 50500, 59000, 56500, 61000, 64000, null],
          note: 'Consolidated revenue — the line Meta guides every quarter. The actual has landed in the top half of the guidance range (or above it) in nearly every print since 1Q23 — 4Q25 printed ABOVE the high end, and 2Q26 ($60.8B, +28% YoY) grazed the top of its $58–61B guide and beat the Street’s $60.2B. Summit = the model’s frozen per-quarter projection. Consensus per LSEG/Refinitiv, earnings-day coverage. 3Q26 guide: $61–64B (~1% FX headwind assumed).' },
        adv: { label: 'Advertising Revenue', short: 'Advertising', group: 'Revenue', unit: 'usdM',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [28101, 31498, 33643, 38706, 35635, 38329, 39885, 46783, 41392, 46563, 50082, 58137, 55024, 59363, null, null],
        ...
        foa: { label: 'Family of Apps Revenue', short: 'Family of Apps', group: 'Revenue', unit: 'usdM',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [28306, 31723, 33936, 39040, 36015, 38718, 40319, 47302, 41902, 47146, 50772, 58938, 55909, 60370, null, null],
        ...
        rl: { label: 'Reality Labs Revenue', short: 'Reality Labs', group: 'Revenue', unit: 'usdM',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [339, 276, 210, 1071, 440, 353, 270, 1083, 412, 370, 470, 955, 402, 431, null, null],
        ...
        oth: { label: 'Other Revenue (FoA)', short: 'Other revenue', group: 'Revenue', unit: 'usdM',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [205, 225, 293, 334, 380, 389, 434, 519, 510, 583, 690, 801, 885, 1007, null, null],
        ...
        opinc: { label: 'Operating Income (GAAP)', short: 'Op. income', group: 'Profitability', unit: 'usdM', marginOf: 'rev', marginLabel: 'operating margin',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [7227, 9392, 13748, 16384, 13818, 14847, 17350, 23365, 17555, 20441, 20535, 24745, 22872, 18775, null, null],
          summit: [6799, 8300, 11827, 14235, 13578, 15406, 15774, 19870, 17394, 18372, 20904, 24420, 24990, 29399, 30398, 34417],
          cons:   [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          note: 'GAAP income from operations. Meta does not guide operating income directly — it guides full-year total expenses ($165–169B for 2026, low end raised at the 2Q26 print to absorb the legal charges). 2Q26 ($18.8B, −8% YoY, 31% margin) is the dirtiest print in the window: it carries $2.40B of legal-proceedings charges + $1.18B of severance from the May 2026 headcount reduction — ex those items ~$22.4B (derived), still well under the live vintage’s $29.4B. Management reiterated 2026 operating income ABOVE 2025. ⚠ Forward quarters come from the 2026-05-22 vintage, which re-rated FY26 op income sharply — see the annual view note.' },
        foaop: { label: 'Family of Apps Op. Income', short: 'FoA op. income', group: 'Profitability', unit: 'usdM', marginOf: 'foa', marginLabel: 'FoA operating margin',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [11219, 13131, 17490, 21030, 17664, 19335, 21778, 28332, 21765, 24971, 24967, 30766, 26900, 23394, null, null],
        ...
        rlop: { label: 'Reality Labs Op. Income (Loss)', short: 'RL op. loss', group: 'Profitability', unit: 'usdM',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [-3992, -3739, -3742, -4646, -3846, -4488, -4428, -4967, -4210, -4530, -4432, -6021, -4028, -4619, null, null],
          ...
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          note: 'Reality Labs operating loss — the bet’s quarterly bill, $4–6B a quarter. 4Q25’s $6.0B was the widest loss on record, wider than both the model ($4.7B) and StreetAccount ($5.7B) expected; 2026 is tracking narrower (1Q $4.0B, 2Q $4.6B vs the Street’s $5.1B — a $450M smaller loss than expected). Frozen model projections stop at 4Q25; ⚠ the Summit DB stores 3Q23 as −$3,472M but the press release says −$3,742M (transposition — the actual is shown; flagged for the model owner). Meta guided 2026 RL losses "similar to 2025 levels".' },
        netinc: { label: 'Net Income (GAAP)', short: 'Net income', group: 'Profitability', unit: 'usdM', marginOf: 'rev', marginLabel: 'net margin',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [5709, 7788, 11583, 14017, 12369, 13465, 15688, 20838, 16644, 18337, 2709, 22768, 26773, 15848, null, null],
          summit: [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          cons:   [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          note: 'GAAP net income. Two quarters carry one-time tax items that swamp the operating trend: 3Q25’s $2.7B bottom line includes the −$15.9B non-cash OBBBA deferred-tax charge, and 1Q26’s $26.8B includes the mirror-image one-time tax benefit. 2Q26 ($15.8B, −14% YoY) carries the $3.58B of legal + severance charges and a normalized 16% tax rate (guided 15–17% for the rest of 2026). The Summit model carries net income annually only.' },
        eps: { label: 'Diluted EPS (GAAP)', short: 'EPS', group: 'Profitability', unit: 'eps',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [2.20, 2.98, 4.39, 5.33, 4.71, 5.16, 6.03, 8.02, 6.43, 7.14, 1.05, 8.88, 10.44, 6.18, null, null],
          summit: [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          cons:   [2.03, 2.91, 3.63, 4.96, 4.32, 4.73, 5.25, 6.77, 5.28, 5.92, 6.69, 8.21, 6.79, 7.20, null, null],
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          note: 'GAAP diluted EPS vs the pre-print Street estimate (Refinitiv through 2Q23, LSEG after). Meta beat the Street every print through 1Q26 on a comparable basis — three quarters need the one-time lens: 3Q25’s $1.05 GAAP print carries the −$15.9B OBBBA charge (company-stated $7.25 ex-charge vs $6.69 expected — a beat), 1Q26’s $10.44 carries the mirror one-time benefit (Street-comparable adjusted $7.31 vs $6.79), and 2Q26’s $6.18 vs ~$7.20 expected carries $3.58B pre-tax of legal + severance charges — roughly in line ex-charges (derived). Meta does not guide EPS; the Summit model carries no per-quarter EPS line.' },
        capex: { label: 'Capital Expenditure', short: 'CapEx', group: 'Profitability', unit: 'usdM', marginOf: 'rev', marginLabel: 'capex % of revenue',
          periods: ['1Q23','2Q23','3Q23','4Q23','1Q24','2Q24','3Q24','4Q24','1Q25','2Q25','3Q25','4Q25','1Q26','2Q26','3Q26','4Q26'],
          act:    [7090, 6350, 6760, 7900, 6720, 8470, 9200, 14836, 13690, 17010, 19370, 22140, 19840, 31078, null, null],
          summit: [null, null, null, null, null, null, null, null, null, null, null, null, 28470, 36384, 41424, 47043],
          cons:   [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          note: 'Capital expenditure as Meta states it (including principal payments on finance leases), positive spend, per the 8-K releases. The AI build-out went vertical in 2Q26: a record $31.1B in ONE quarter (vs $19.8B in 1Q26 and $17.0B a year ago), taking 1H26 to $50.9B and squeezing quarterly FCF to $784M. ⚠ Basis note: the Summit model’s capex line is purchases of property & equipment only (ex-finance-leases), ~2–4% lower — its per-quarter projections start 1Q26 and have straddled the prints ($28.5B vs $19.8B in 1Q, $36.4B vs $31.1B in 2Q); the quarterly projections also sum to ~$153B for 2026 vs the model’s own $141B annual line (both flagged). Meta guides capex ANNUALLY — see the Annual view for the guidance band.' }
      },
      sections: [
    ...
    y: {
      ...
      metrics: {
        ...
        capex: { label: 'Capital Expenditure', short: 'CapEx', group: 'Profitability', unit: 'usdM', marginOf: 'rev', marginLabel: 'capex % of revenue',
          ...
          cons:   [null, null, null, null, null, null, null],
          guideLo:[null, null, 27000, 38000, 70000, 130000, null],
          guideHi:[null, null, 29000, 40000, 72000, 145000, null],
          note: 'Capital expenditure as Meta states it (incl. finance-lease principal), positive spend. The AI ramp: $39B → $72B → a guided $130–145B in 2026 (narrowed at the 2Q26 print from $125–145B; originally $115–135B) and a modeled $174B in 2027 — capex intensity passing 55% of revenue. 1H26 already spent $50.9B. Guidance band = the FINAL full-year capex guide given for each year (2023: $27–29B; 2024: $38–40B; 2025: $70–72B); every year has landed inside or at the top of the final guide. Basis note: the Summit line ($72.1B held for 2025 on Dec-15; $140.9B for 2026) is purchases of PP&E ex-finance-leases, ~2–4% below Meta’s stated basis.' },
        eps: { label: 'Diluted EPS (GAAP)', short: 'EPS', group: 'Profitability', unit: 'eps',
          periods: ['2021','2022','2023','2024','2025','2026','2027'],
