...
//
// HEADLINE SET = the file's default metrics THAT HAVE VALID VALUES for MA (§6a "render the metrics
// the file confirms — a missing consensus doesn't disqualify one if the actual exists; corruption
// does"). The file carries 9 headline slots; MA renders EIGHT: revenue, operating income, EBITDA,
// EPS, operating cash flow, capex, D&A, shares outstanding. GROSS PROFIT (slot 9) is EXCLUDED — it
// is not a real MA series: every quarterly cell is `Error 2042` (#N/A) and the only "numeric" fy+
// cells are D&A copied in by a source mis-population. This matches the business: Mastercard has no
// cost-of-revenue line, so no gross profit / gross margin exists (see ddMarginsBody). Capex & D&A
// are asset-light (~$40–300M/qtr), so they render in $M, not $B, to keep resolution; capex comes
// through the file negative and is shown as a positive magnitude. Shares outstanding is a COUNT
// (u:'B', no $). Every array below was generated by parsing BBG_CONSENSUS.txt and VALIDATED by
// reproducing the pre-existing rev/opinc/EBITDA/EPS arrays byte-for-byte.
//
...
var CE_CONS = {
  ...
  m:[
    ...
    { k:'Operating cash flow', u:'$B', t:'ok', code:'CB_CF_NET_CASH_OPERATING_ACT',
      qr:[[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,3.8],[null,null,2.9,3.2],[null,3.5,3.6,3.9],[4,3.9,3.9,3.8],[3.8,3.9,3.9,3.9],[3.4,3.4,3.4,3.3],[3.9,3.9,3.9,4],[4.3,4.4,4.7,5],[4.4,4.7,4.8,4.9],[3.5,3.7,3.6,3.4],[4.9,4.8,4.9,4.7],[5.6,5.8,5.8,5.8],[5.5,5.7,5.7,null],[4.1,4.2,null,null],[5.3,null,null,null]],
      qa:[3.1,1.9,2.7,3.2,4.1,1.7,3.1,5.1,4.8,2.4,4.6,5.7,5,3,3.8,null,null,null,null],
      qy:[null,null,null,null,3.1,1.9,2.7,3.2,4.1,1.7,3.1,5.1,4.8,2.4,4.6,5.7,5,3,3.8],
      qq:[null,3.1,1.9,2.7,3.2,4.1,1.7,3.1,5.1,4.8,2.4,4.6,5.7,5,3,3.8,null,null,null] },
    { k:'Capex', u:'$M', t:'ok', code:'CF_PURCHASE_OF_FIXED_PROD_ASSETS',   // asset-light: file carries it negative; shown as positive magnitude in $M
      qr:[[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,104],[null,null,105,99],[null,108,102,106],[114,107,110,120],[113,110,119,100],[109,113,111,120],[114,112,118,129],[115,122,137,128],[120,135,127,122],[144,134,128,147],[130,127,138,138],[147,171,178,180],[160,164,169,null],[159,163,null,null],[168,null,null,null]],
      qa:[130,110,80,104,77,157,115,107,95,159,40,178,112,154,291,null,null,null,null],
      qy:[null,null,null,null,130,110,80,104,77,157,115,107,95,159,40,178,112,154,291],
      qq:[null,130,110,80,104,77,157,115,107,95,159,40,178,112,154,291,null,null,null] },
    { k:'D&A', u:'$M', t:'ok', code:'CF_DEPR_AMORT',
      qr:[[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,203],[null,null,205,206],[null,210,213,213],[217,221,223,230],[222,224,232,229],[221,226,228,235],[238,240,248,267],[244,252,270,277],[254,275,286,292],[267,279,285,295],[292,298,307,303],[301,316,313,315],[320,320,324,null],[319,323,null,null],[339,null,null,null]],
      qa:[184,191,192,211,205,216,225,225,231,275,281,290,297,299,309,null,null,null,null],
      qy:[null,null,null,null,184,191,192,211,205,216,225,225,231,275,281,290,297,299,309],
      qq:[null,184,191,192,211,205,216,225,225,231,275,281,290,297,299,309,null,null,null] },
    { k:'Shares outstanding', u:'B', t:'ok', code:'IS_SH_FOR_DILUTED_EPS',   // a COUNT (no $): diluted share count, in billions
      qr:[[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,null],[null,null,null,0.94],[null,null,0.93,0.93],[null,0.93,0.93,0.93],[0.92,0.92,0.93,0.93],[0.92,0.92,0.92,0.92],[0.92,0.92,0.92,0.92],[0.91,0.91,0.91,0.91],[0.91,0.91,0.9,0.9],[0.9,0.9,0.9,0.9],[0.89,0.89,0.89,0.89],[0.89,0.89,0.89,0.89],[0.88,0.88,0.88,0.88],[0.88,0.88,0.87,null],[0.87,0.87,null,null],[0.86,null,null,null]],
      qa:[null,null,null,0.94,0.94,0.94,0.93,0.93,0.92,0.91,0.91,0.91,0.9,0.89,0.88,null,null,null,null],
      qy:[null,null,null,null,null,null,null,0.94,0.94,0.94,0.93,0.93,0.92,0.91,0.91,0.91,0.9,0.89,0.88],
      qq:[null,null,null,null,0.94,0.94,0.94,0.93,0.93,0.92,0.91,0.91,0.91,0.9,0.89,0.88,null,null,null] },
...
// Annual FY view (legacy struct — the live Setup/Results charts now render from maResults/MA_SETUP;
// kept in sync so it is never a source of stale/false data): reported actuals (archive fy0) + BBG
// consensus (forward fy+N) + the Summit DCF model's own annual line.
// MA DOES issue numeric FY guidance (net-revenue-growth ranges, opex), so guidance:true — but that
// band is NOT a Bloomberg line; it is authored separately, not
// fabricated here. summit = Summit DCF model (MA, snapshot 2026-07-30, projection_history), $B;
// Summit's op-income def runs below the BBG-comparable actual — that is its own line, not a
// restatement. Values $B (archive/model scale M → /1,000).
var CE_ANNUAL = {
  years:[2022,2023,2024,2025,2026,2027],
  guidance:true,                                            // MA issues numeric FY guidance (authored elsewhere, not in BBG)
  m:[
    { k:'Net revenue', u:'$B', actual:[22.2,25.1,28.2,32.8,null,null], bbg:[null,null,null,null,37.1,41.8], summit:[22.2,25.1,28.2,32.8,38.1,41.7] },
    { k:'Operating income', u:'$B', actual:[12.7,14.5,16.5,19.4,null,null], bbg:[null,null,null,null,22.1,24.6], summit:[12.1,13.8,15.3,18.6,22.3,24.0] },
    { k:'EBITDA', u:'$B', actual:[13.4,15.3,17.4,20.5,null,null], bbg:[null,null,null,null,23.4,26.5], summit:[12.8,14.8,16.5,20.1,24.0,26.9] }
  ]
};
...
function ceFmtV(u,v){
  ...
  if(u==='$B') return '$'+(+v)+'B';
  if(u==='$M') return '$'+(+v)+'M';            // MA capex/D&A: sub-$0.3B, so shown in millions
  if(u==='B')  return (+v)+'B';
  return String(v);
}
...
function ceAnnualBody(){
  return '<div class="ce-ann" style="margin:20px 0 4px;padding:16px 0 0;border-top:2px solid var(--bdr)">'+
    '<div class="ov-sec-h">The Setup picture — reported vs Street vs Summit (Summit annual only): pick any line, window the period with the lever, toggle margins</div>'+
...
function ceTkFmt(u,v){
  ...
  if(u==='$M') return '$'+Math.round(+v)+'M';  // MA capex/D&A: sub-$0.3B, so shown in millions
