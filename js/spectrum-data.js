...
export const SPECTRUM_COMPANIES = [
  {
    ticker: 'NVDA', name: 'NVIDIA', x: 4, y: 22, profile: 'nvidia',
  ...
  {
    ticker: 'AMZN', name: 'Amazon.com', x: 12, y: 82, profile: 'amzn',
  ...
  {
    ticker: 'META', name: 'Meta Platforms', x: 20, y: 72, profile: 'meta',
  ...
  {
    ticker: 'SPOT', name: 'Spotify Technology', x: 28, y: 8, profile: 'spot',
  ...
  {
    ticker: 'UBER', name: 'Uber Technologies', x: 39, y: 14, profile: 'uber',
  ...
  {
    ticker: 'LYFT', name: 'Lyft', x: 44, y: 20, profile: 'lyft',
  ...
  {
    ticker: 'CART', name: 'Instacart (Maplebear)', x: 34, y: 9, profile: 'instacart',
  ...
  {
    ticker: 'SOFI', name: 'SoFi Technologies', x: 53, y: 57, profile: 'sofi',
  ...
  {
    ticker: 'IBKR', name: 'Interactive Brokers', x: 47, y: 44, profile: 'ibkr',
  ...
  {
    ticker: 'PAC', name: 'Grupo Aeroportuario del Pacífico', x: 62, y: 92, profile: null,
  ...
  {
    ticker: 'CVNA', name: 'Carvana', x: 72, y: 78, profile: null,
  ...
  {
    ticker: 'TBBB', name: 'BBB Foods (Tiendas 3B)', x: 80, y: 62, profile: 'bbb',
  ...
  {
    ticker: 'VITL', name: 'Vital Farms', x: 89, y: 45, profile: null,
  ...
  {
    ticker: 'TPL', name: 'Texas Pacific Land', x: 96, y: 15, profile: null,
