...
const ROLE_CONFIG = {
  ...
  admin: { name: 'Admin', label: 'Admin', allowedPages: ['companies', 'spectrum', 'industry-analysis', 'market-analysis', 'hedge-funds', 'team', 'fund-returns', 'covered-calls'], defaultPage: 'companies' },
};
