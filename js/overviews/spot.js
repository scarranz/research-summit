  ...
  { q:'Q2 2026', status:'reported', date:'reported Tue Aug 4, 2026 · BEFORE market open (Q&A 8:00am ET)',
    ...
    results:{
      ...
      summary:{ paras:[
        ...
        { p:'<b>The call answered three of the four worries — and the one it could not answer is the one that matters.</b> The gross-margin step down to 32.9% turned out to be “a typical charge we take in the third quarter to account for our annual exposure to regulatory fees”, and is still ~130bp above the prior year. The advertising line got a dated commitment: “inflect towards double-digit growth in the second half of 2026”, with the rebuild declared finished at 99% of impressions on Spotify’s own stack and advertiser count up 60%. The opex step-up got sized at ~€200M for the full year, personnel flat, explicitly “compute and marketing… not long-term CapEx”. What could not be settled is the <b>11M MAU guide</b>: management says it is deliberate — pulling “the monetization lever” through sign-up friction, ad load and free-tier limits in emerging markets — and that it “will not affect subs growth in the near term”. That is a real strategy and an unfalsifiable claim for exactly one quarter.',
          moreLabel:'＋ more — why the market sold it anyway',
          more:'<p>Because the guide split the wrong way against the sell-side numbers: <b>revenue guided ABOVE</b> consensus (€5.0B vs ~€4.93B, LSEG) but <b>operating income BELOW</b> (€670M vs ~€677.8M, Visible Alpha) and <b>MAU well below</b> (788M vs ~793.6M). Guiding the top line up while guiding users and profit down is the combination that reads as buying growth that is not arriving. The call\'s explanations landed after the pre-market move and were, on the substance, largely reassuring — which is why the closing print is worth recording separately from the ~4% pre-market reaction.</p>' },
        { p:'<b>What to hold onto.</b> Nothing in the reported quarter broke: margins are at records, pricing compounds, subscribers crossed 300M, cash builds, and headcount has been flat for three years while revenue per employee is “on track to double”. The forward card is where the debate sits, and after the call it narrows to one falsifiable question. Summit is 4.3% above the operating-income guide with segment lines implying ~33.6% gross margin — the same bet on conservatism that has paid for five straight quarters, now with the added detail that the model is evidently not carrying the Q3 regulatory charge. <b>Q3 settles it:</b> subscribers at 305M with ARPU still compounding while MAU decelerates would confirm the funnel is being optimised deliberately; both slowing together would mean the "monetization lever" was a description of a problem rather than a decision.' }
      ] } },
...
var WL_ROWS=[
  ...
  { id:'wl007', q:'Q3 2026', rank:1, theme:'“Pulling the monetization lever” — does subscriber growth really survive it?',
    tags:['users','guidance','pricing'], trackSince:'Q3 2026', trackUntil:null,
    seededBy:{ q:'Q2 2026', tripped:true, n:'MAU added 16M against 17M guided, and the next quarter is then marked down to 11M — 5.6M below consensus' },
    definition:'Spotify missed its own MAU guide and then guided Q3 to an 11M add, the slowest in this dataset and ~5.6M below where the Street sat. Management says this is deliberate: friction added to sign-up, ad load and the free tier in emerging markets to convert better rather than to grow wider — and that it “will not affect subs growth in the near term”. That claim is precise, dated and falsifiable, and it is now the central question on the name. This hook tracks it: subscribers at 305M with ARPU still compounding confirms the funnel is being optimised; both lines slowing together means the lever framing described a problem rather than a decision.',
    src:'Q2 2026 call (4 Aug): Norström — “sometimes we pull the growth lever, and sometimes we pull the monetization lever. Here we\'re starting to pull the monetization lever”; measures are “tweaking the sign-up to get a higher quality MAU throughput”, deprecating “lower-end Android device support”, and “friction in both ad load and some limitations in our free tier”. Luiga: “growth rates in developed markets remain stable.” Asked about labels reporting an industry-wide premium slowdown, Norström: “I\'m very confident… optimizing for a healthy funnel… not slowing it down.” Guide: 788M MAU (vs ~793.6M Visible Alpha) and 305M subs.' },
  { id:'wl008', q:'Q3 2026', rank:2, theme:'The advertising “inflection to double-digit growth in H2 2026”',
    tags:['advertising','sax','guidance'], trackSince:'Q3 2026', trackUntil:null,
    seededBy:{ q:'Q2 2026', tripped:true, n:'The clean comp against the SAX launch produced the same +3% cc as the quarter before it — and management then committed to double-digit H2' },
    definition:'The successor to the Q2 hook, and it is now a promise rather than a question. Two years of rebuilding produced +3% constant-currency twice running, and the clean comp against the April 2025 exchange launch failed to show an inflection. Management has nonetheless committed to double-digit growth in the second half of 2026, declared the migration finished, and put a 40% long-run segment gross margin on the record. Q3 is the first of the two quarters that have to deliver it. This is the most checkable commitment management made on the call.',
    src:'Q2 2026 call: Luiga — “we continue to expect our ads business to inflect towards double-digit growth in the second half of 2026”, and margin moving “from the 20% range we have today towards 40% over time”. Norström — “99% of all the impressions [are] now on our own ad stack”; automated channels ~40% of ad revenue, up from 30%; “33,000 active advertisers… 60% up from last year”, 7,000 using the AI audio asset-creation tool. Q2 actual: €446M, +1% reported / +3% cc. Summit carries €496M for Q3 (~+11%).' },
  { id:'wl009', q:'Q3 2026', rank:3, theme:'The €200M investment year — does opex actually moderate in Q4?',
    ...
    definition:'Reported operating expenses grew 3%, which looks benign and is not the real number — excluding currency and social charges they grew 19%, on marketing plus cloud and AI. Management has now sized the programme at ~€200M for the full year, said personnel is flat, and framed it as controllable spend rather than capital. The word to hold them to is the sequencing: invest first, then “focus on cost and efficiency”. This hook tracks whether the moderation actually arrives in Q4 and whether the 20%+ operating margin by 2030 path depends on it.',
    src:'Q2 2026 call: Luiga — marketing and AI investments drive “approximately €200 million in incremental operating expense for the full year”, personnel flat. Söderström — “we started this year by investing… leading in this wave of using AI… now [we are] focusing on cost and efficiency”; it is “compute and marketing… within our control… not long-term CapEx”, and “over the last three years, we have not increased headcount while revenue per employee is on track to double”. Q2 opex €941M; Q3 operating income guided €670M vs ~€677.8M consensus.' },
  { id:'wl006', q:'Q3 2026', rank:4, theme:'The Q3 regulatory-fee charge — verify it is really annual',
    tags:['margin','investor-day'], trackSince:'Q3 2026', trackUntil:null,
    seededBy:{ q:'Q2 2026', tripped:false, n:'Gross margin set an all-time record at 33.4% and the very next guide takes 50bp back' },
    definition:'Demoted from the top of this list by the call. Spotify printed a record 33.4% gross margin and then guided Q3 down to 32.9%, which looked like the first guided step away from the 35–40% by 2030 commitment. Luiga explained it as reinvestment plus “a typical charge we take in the third quarter to account for our annual exposure to regulatory fees in one of our markets”, and anchored the guide as ~130bp ABOVE the prior year. That is a satisfying answer, and it is also unverified. This hook exists to check it rather than to accept it: if the charge is genuinely annual and Q3-seated, it should be visible in 3Q25 and 3Q24 as well.',
    src:'Q2 2026: gross margin 33.4% actual vs 33.1% guided, +193bp YoY; Premium 34.9%, Ad-Supported 19.1%. Q3 guide 32.9%, described by Luiga as “approximately 130 basis points above the prior year”. Investor Day (21 May 2026): 35–40% gross margin and 20%+ operating margin by 2030 against 32.0% in FY2025. Summit\'s segment lines imply ~33.6% for Q3, i.e. the model is not carrying the charge.' },
  { id:'wl010', q:'Q3 2026', rank:5, theme:'Does the buyback lean into the drawdown?',
    ...
    seededBy:{ q:'Q2 2026', tripped:false, n:'No analyst asked about capital allocation on the Q2 call, and management did not volunteer it' },
    definition:'Spotify has €9.4B of cash, €3.3B of LTM free cash flow, a structurally capital-light model, and a stock that just fell on a guide rather than on a quarter. The Q3 repurchase pace is the most direct statement management can make about how it values its own shares here — and unlike everything else on this list, it requires no interpretation. It earns a slot precisely because it went unasked: thirteen analyst questions on the Q2 call covered AI products, ticketing, engagement and pricing, and not one covered capital allocation.',
    src:'Q2 2026 deck: $662M repurchased year to date through Aug 3 2026, ~30% ahead of 2025 levels; ~2.2M shares (≈1% of shares outstanding) since repurchases resumed in 2025. €232M of repurchases in the quarter itself. Capital allocation sits with Daniel Ek as executive chairman, not with the co-CEOs — which may be why the co-CEOs were not asked.' },
  ...
  { id:'wl001', q:'Q2 2026', rank:1, theme:'The operating-income guide: conservatism or the end of margin expansion?',
    ...
    thread:[
      { q:'Q2 2026', n:'<b>Conservatism won the quarter — with an asterisk.</b> €655M against the €630M guide, a fifth consecutive beat. But €9M of the €25M came from social charges landing below forecast because the SHARE PRICE FELL, not from operations; the guide had embedded €10M at a $484.91 close and the actual was €1M. Strip it and the beat is ~€16M, on gross-margin strength, against opex growing 19% YoY ex-FX and social charges.' },
      { q:'Q2 2026', n:'<b>Q3 re-poses it harder, and now against the Street.</b> €670M guided is only €15M above this print on ~€223M more revenue — and it is <b>below the ~€677.8M consensus</b> (Visible Alpha), which is half of why the shares fell. The call sized the cause: ~<b>€200M of incremental marketing and AI spend for the full year</b>, personnel flat, described by Söderström as “compute and marketing… within our control… not long-term CapEx” with the year moving from investment to “cost and efficiency”. <b>Closed in this framing</b> — the conservatism-vs-end-of-expansion binary has been answered (it is neither; it is a sized, deliberate investment year) — and carried to Q3 as hook #3, which tracks whether the moderation actually arrives.' }
    ] },
  { id:'wl002', q:'Q2 2026', rank:2, theme:'Has the SAX rebuild stopped shrinking advertising?',
    ...
    thread:[
      { q:'Q2 2026', n:'<b>Answered, and the answer closes this framing.</b> It has stopped shrinking — €446M, +1% reported and +3% constant-currency — but it has not started growing: that is the SAME +3% cc as Q1, in the quarter that was supposed to be the clean comp against the April 2025 launch. The transition-dip explanation has been tested and did not hold. The margin half of the trade worked (19.1% gross margin, +179bp).' },
      { q:'Q2 2026', n:'<b>On the call, management converted the question into a commitment.</b> Luiga: “we continue to expect our ads business to <b>inflect towards double-digit growth in the second half of 2026</b>.” Norström declared the migration complete — “99% of all the impressions [are] now on our own ad stack” — with automated channels at ~40% of ad revenue (from 30%) and 33,000 active advertisers, +60% YoY. Luiga on the long-run margin: from “the 20% range we have today towards 40% over time”. <b>Closed here and carried to Q3 as hook #2</b>, restated as a promise to be checked rather than a question to be asked.' }
    ] },
  ...
  { id:'wl004', q:'Q2 2026', rank:4, theme:'Gross margin against the 35–40% promise',
    ...
    thread:[
      { q:'Q2 2026', n:'<b>The print helped; the guide looked alarming; the call defused it.</b> 33.4% actual against a 33.1% guide — an all-time record and +193bp YoY, with both segments contributing (Premium 34.9%, Ad-Supported 19.1%). Q3 was then guided to <b>32.9%</b>, a 50bp step DOWN, unexplained in the deck. On the call Luiga explained it as reinvestment plus “<b>a typical charge we take in the third quarter to account for our annual exposure to regulatory fees in one of our markets</b>”, and reframed the guide as <b>~130bp ABOVE the prior year</b>. <b>Stays open but demoted</b> — it carries to Q3 as hook #4, reframed from “is the trajectory breaking?” to “verify the charge is genuinely annual by checking 3Q25 and 3Q24”.' }
    ] },
