...
export var uberResults = {
  ...
  views: {
    q: {
      ...
      metrics: {
        rev: { label: 'Revenue (Total)', seg: 'Total', short: 'Total revenue', group: 'Totals', unit: 'usdM',
        ...
        gb: { label: 'Gross Bookings (Total)', seg: 'Total', short: 'Total GB', group: 'Totals', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
        ...
        mobgb: { label: 'Mobility Gross Bookings', seg: 'Mobility', short: 'Mobility GB', group: 'Mobility', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
          ...
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null] },
        mobrev: { label: 'Mobility Revenue', seg: 'Mobility', short: 'Mobility rev.', group: 'Mobility', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
          ...
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null] },
        delgb: { label: 'Delivery Gross Bookings', seg: 'Delivery', short: 'Delivery GB', group: 'Delivery', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
          ...
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null] },
        delrev: { label: 'Delivery Revenue', seg: 'Delivery', short: 'Delivery rev.', group: 'Delivery', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
          ...
          guideLo:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null],
          guideHi:[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null] },
        frgb: { label: 'Freight Gross Bookings', seg: 'Freight', short: 'Freight GB', group: 'Freight', unit: 'usdM',
          periods: ["3Q22", "4Q22", "1Q23", "2Q23", "3Q23", "4Q23", "1Q24", "2Q24", "3Q24", "4Q24", "1Q25", "2Q25", "3Q25", "4Q25", "1Q26", "2Q26", "3Q26", "4Q26", "1Q27"],
      ...
      sections: [
        { key: 'top', label: 'Top Line', defaultMetric: 'gb', groups: [
          { label: 'Gross Bookings', keys: ['gb', 'mobgb', 'delgb', 'frgb'] },
          { label: 'Revenue',        keys: ['rev', 'mobrev', 'delrev'] },
        ] },
  ...
  evolution: {
    ...
    // FY2025 leads the list because it is the only year here that has actually LANDED — it is what
    // makes the "Reported" marker mean something. Read it as one estimate column and then a flat
    // line: after the 4Q25 print the model's annual row carries the reported figure (52,017 rev /
    // 8,730 EBITDA) rather than a forecast, and Bloomberg's stored FY2025 line likewise settles at
    // its final pre-print consensus. That flattening IS the story the toggle tells.
    ...
    metrics: {
      rev: { label: 'Revenue (Total)', seg: 'Total', unit: 'usdM',
        summit: [[52113.3, 52017, 52017, 52017, 52017], [61688.9, 61971.8, 58695.2, 58695.2, 59137.4], [73404.8, 72490.4, 68127.7, 68127.7, 68838.9], [81964.4, 82203.1, 78362, 78362, 79079.9], [98410.2, 98519.3, 93642.3, 93642.3, 94365.4]],
        cons: [[51952.4, 51956.1, 51956.1, 51956.1, 51956.1], [60448.7, 60509.1, 58205.2, 58183.7, 58176.7], [69193.4, 69327, 66806.5, 66857, 66911], [77984.6, 78273.6, 75643, 76607.5, 76723.1], [85783.4, 86818.3, 83149.6, 85308.5, 85341.9]],
        prior: { summit: [43978, 43978, 43978, 43978, 43978] },
        note: 'FY2025 is deliberately blank on BOTH lines. Summit\u2019s stored value swings from 2.02 in December to 3.08 in February against a 2.47 print \u2014 the model restated a closed year by +52%, which is not a forecast series \u2014 and Bloomberg\u2019s adjusted-EPS basket only reconciles from 4Q25, so any fiscal year containing earlier quarters is off-basis (it reads 2.9 and 5.4 against the same 2.47). The forward years are usable and carry the sharpest disagreement in the block: Summit raised FY2026 EPS at every snapshot, 3.00 \u2192 3.68, while the Street CUT it 3.58 \u2192 2.91 over the same months. Same company, same quarters, opposite direction. The dashed line here is NOT the same vintage of consensus as the one on revenue and EBITDA. Those two carry a Bloomberg pull the model took on its own save date; this one is the workbook read as of each snapshot \u2014 the Street\u2019s latest export up to that day, which on the December column is six weeks old. Read it for direction, not for a same-day gap.' },
      ebitda: { label: 'Adjusted EBITDA', unit: 'usdM', marginOf: 'rev', marginLabel: 'EBITDA margin (% of rev)',
        summit: [[8760.2, 8730, 8730, 8730, 8730], [11451.1, 11021, 11546.7, 11546.7, null], [15335, 13643.6, 14817.4, 14817.4, null], [17831.5, 17486, 17397.3, 17397.3, null], [22251.9, 21853.5, 21495.5, 21495.5, null]],
        cons: [[8718, 8718.2, 8718.2, 8718.2, 8718.2], [10969.5, 10978.1, 10833.5, 11057.4, 11382], [13410.1, 13460.3, 13014.2, 13423.8, 13538.7], [15789.1, 15725.1, 15960.5, 16173.2, 16288.2], [18037, 18145.5, 18099, 18530.6, 18746.2]],
        note: 'EBITDA held far steadier than revenue through the re-rates \u2014 FY26 sits at ~$11.5B in every snapshot that carries it, FY27 dipped to $13.6B in Feb then recovered to $14.8B by May. The consensus line is the one that moved: the Street has raised FY26 EBITDA in every snapshot since May ($10.8B \u2192 $11.1B \u2192 $11.4B) and has now essentially caught Summit. **The Aug 5 column is blank by design** \u2014 that vintage re-cut revenue and the adjusted P&L but left the EBITDA rows at zero, not yet refreshed for the print; it is a gap in the model, not a forecast of nothing. In the margin view the implied EBITDA margin rose as revenue was cut: FY26 ~19.7% at the last complete snapshot vs ~18.6% in Dec \u2014 the arithmetic of a lower revenue base on a steady profit line. FY2025 says both sides read the profit line as accurately as the top line: Summit\u2019s December $8,760M landed 0.3% above the $8,730M print, the Street\u2019s $8,718M 0.1% below \u2014 and unlike revenue, the Street never moved its FY2025 number at all across eight months.' },
      opinc: { label: 'Operating Income (non-GAAP)', unit: 'usdM', marginOf: 'rev', marginLabel: 'operating margin (% of rev)',
        ...
        cons: [[6103.4, 6165, null, null, null], [8490.2, 8623.2, 8604, 8778.2, 8778.2], [11043.1, 11039.4, 10784.5, 11010, 11010], [12903.9, 13229.5, 13375.4, 13377.3, 13377.3], [14991.1, 15615.6, 15549.2, 15833.6, 15833.6]],
      ...
      gb: { label: 'Gross Bookings (Total)', seg: 'Total', unit: 'usdM',
        ...
        cons: [[190979.7, 192502.4, null, null, null], [221827.6, 224978.6, 230927, 234383.6, 234383.6], [252644.6, 258320.5, 266777.3, 271760.8, 271760.8], [285282.3, 291835.5, 301207.6, 307103.1, 307103.1], [314499.9, 325734.5, 336578.7, 342261.2, 342261.2]],
      ...
      mobgb: { label: 'Mobility Gross Bookings', seg: 'Mobility', unit: 'usdM',
      ...
      mobrev: { label: 'Mobility Revenue', seg: 'Mobility', unit: 'usdM',
      ...
      delgb: { label: 'Delivery Gross Bookings', seg: 'Delivery', unit: 'usdM',
      ...
      delrev: { label: 'Delivery Revenue', seg: 'Delivery', unit: 'usdM',
      ...
      frgb: { label: 'Freight Gross Bookings', seg: 'Freight', unit: 'usdM',
      ...
      eps: { label: 'EPS (Non-GAAP)', unit: 'eps',
        ...
        cons: [[null, null, null, null, null], [3.5836, 3.5627, 3.298, 2.9122, 2.9122], [4.5819, 4.6076, 4.3136, 4.5238, 4.5238], [5.1871, 5.243, 5.4667, 5.5781, 5.5781], [6.1885, 6.3394, 6.6671, 6.9127, 6.9127]],
