...
// Not rendered (the data-status callout was retired); kept current so nobody reads a stale status here.
export var SN_DD_INTRO = 'SharkNinja has no Summit DCF model. Street consensus comes from Bloomberg: SN joined BBG_CONSENSUS.txt on Sep 17, 2026 with 10 snapshots (May 2024 – Aug 2026), which feed the vintage picker and surprise scorecard on Evolution ▸ Results and gate the Earnings Setup chart to Bloomberg\'s authorized lines. Evolution ▸ Estimates still needs an evolution block generated from Summit model saves, so it shows a notice. Valuation ▸ Historic Multiple reads Bloomberg\'s own daily NTM / 2GY / 3GY multiples (frozen Sep 17, 2026); Target Multiple defaults to SN\'s own five-year-average NTM multiples (19× P/E, 12× EV/EBITDA).';
