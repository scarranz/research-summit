...
const ROLE_CONFIG = {
  ...
  admin: { name: 'Admin', label: 'Admin', allowedPages: ['companies', 'market-analysis', 'industry-analysis', 'hedge-funds', 'team', 'fund-returns', 'covered-calls'], defaultPage: 'companies' },
};
